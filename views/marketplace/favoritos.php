                    ...
                    <a href="/marketplace/producto?id=<?php echo $producto->id; ?>">
                        <picture>
                            <?php if (!empty($producto->imagen_principal)): ?>
                                ...
                                <source srcset="/img/productos/<?php echo htmlspecialchars($producto->imagen_principal); ?>.jpg" type="image/jpeg">
                                <img loading="lazy" src="/img/productos/<?php echo htmlspecialchars($producto->imagen_principal); ?>.jpg" alt="Imagen de <?php echo htmlspecialchars($producto->nombre); ?>">
                            <?php else: ?>
